    ...
    return(
        <footer class="footer-distributed">
			...
			<div class="footer-left">
				...
				<p class="footer-company-name">Planova © 2025</p>
			</div>
